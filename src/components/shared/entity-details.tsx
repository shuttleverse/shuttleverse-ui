                        ...
                        <div className="text-center sm:text-left w-full sm:w-auto">
                          <div className="flex items-center justify-center sm:justify-start gap-3 mb-2 sm:mb-3">
                            {isEditing ? (
                              ...
                              <h1 className="text-2xl sm:text-4xl font-bold text-primary-indigo break-words">
                                {entity.name}
                              </h1>
                            )}
                          </div>
                          ...
                          {isEditing ? (
                            ...
                            entity.location && (
                              <a
                                ...
                                className="text-sm sm:text-base text-primary hover:text-primary-indigo transition-colors cursor-pointer break-words"
                              >
                                {entity.location}
                              </a>
                            )
                            ...
                            {isEditing ? (
                              ...
                              entity.website && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="text-sm sm:text-base text-primary hover:text-primary-indigo transition-colors break-all hover:break-words max-w-full"
                                >
                                  {entity.website}
                                </a>
                              )
                              ...
                              <div className="space-y-2">
                                {Object.entries(entity.otherContacts).map(
                                  ([type, contact]) => (
                                    <div
                                      key={type}
                                      className="flex items-center gap-2 sm:gap-3 text-muted-foreground group min-w-0"
                                    >
                                      <span className="w-5 h-5 text-primary group-hover:text-primary-indigo transition-colors flex items-center justify-center flex-shrink-0">
                                      ...
                                      <span className="text-sm sm:text-base text-primary hover:text-primary-indigo transition-colors break-words min-w-0 flex-1">
                                        {contact}
                                      </span>
                                    </div>
                                  )
